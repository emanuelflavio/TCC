...
Diante desse cenário, este trabalho investiga o uso de técnicas de \textit{ensemble learning} aplicadas à análise de sentimentos em comentários de filmes, com ênfase na combinação de classificadores heterogêneos. A pesquisa busca compreender de que forma a diversidade entre modelos e diferentes estratégias de combinação podem influenciar o desempenho preditivo em tarefas de classificação de sentimentos em dados textuais reais. Ao utilizar comentários extraídos da plataforma Letterboxd e da base do IMBd, este estudo contribui para a análise de sentimentos em um contexto pouco explorado na literatura, além de oferecer reflexões sobre a aplicação prática de ensembles heterogêneos no Processamento de Linguagem Natural.
